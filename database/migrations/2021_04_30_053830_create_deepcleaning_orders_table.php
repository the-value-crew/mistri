...
class CreateDeepcleaningOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deepcleaning_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deepcleaning_orders');
    }
}
