                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="mpx-10">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                            <a href="#" target="_blank"><img src="{{asset('gallery/Logo-Option-2.png')}}" width="160" height="100" border="0" alt="" /></a>
                                                                                    ...
                                                                                    <td class="pb-50" style="padding-bottom: 50px;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; margin-bottom: 20px">
                                                                                            @if($user_type == 'user')
                                                                                                <tr>
                                                                                                    <td class="title-36 a-center pb-15" style="font-size:20px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                        <strong>{{$user->name}},Thank you for your order!</strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            ...
                                                                                            @if($user_type == 'admin')
                                                                                                <tr>
                                                                                                    <td class="title-36 a-center pb-15" style="font-size:20px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                        <strong>New Order for {{$order->service->name}} </strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                                                                        {{$user->name}} order for service on <b>{{$order->service->name}}</b> on {{$order->created_at->format('d-M-Y')}}
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="btn-20 btn-secondary c-white l-white" bgcolor="#f3189e" style="font-size:20px; line-height:24px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; min-width:auto !important; border-radius:10px; background:linear-gradient(to right, #9028df 0%,#f3189e 100%); color:#ffffff;">
                                                                                                                            <a href="#" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                                <span class="link c-white" style="text-decoration:none; color:#ffffff;">ORDER ID: #SOU{{$order->id}}</span>
                                                                                                                            </a>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                                            ...
                                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                                ...
                                                                                                                                <tr>
                                                                                                                                    ...
                                                                                                                                    <td class="text-16" style="font-size:16px; line-height:20px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
                                                                                                                                        {{$order->user->userdetail->fulladdress}}
                                                                                                                                        <br />
                                                                                                                                        Flat No : {{$order->user->userdetail->flat_number}}{{$order->user->userdetail->street}},{{$order->user->userdetail->building}}
                                                                                                                                        <br>
                                                                                                                                        {{$order->user->userdetail->additional_direction}}
                                                                                                            ...
                                                                                                            {{--<tr>--}}
                                                                                                                {{--<td class="pb-30" style="padding-bottom: 30px;">--}}
                                                                                                                    {{--<table width="100%" border="0" cellspacing="0" cellpadding="0">--}}
                                                                                                                        {{--<tr>--}}
                                                                                                                            {{--<th class="column-top" valign="top" width="230" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">--}}
                                                                                                                                {{--<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="#" target="_blank"><img src="" border="0" width="120" height="90" alt="" /></a></div>--}}
                                                                                                                            {{--</th>--}}
                                                                                                                            {{--<th class="column-top mpb-15" valign="top" width="30" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;"></th>--}}
                                                                                                                                ...
                                                                                                                                {{--<table width="100%" border="0" cellspacing="0" cellpadding="0">--}}
                                                                                                                                    ...
                                                                                                                                    {{--<tr>--}}
                                                                                                                                        {{--<td class="text-16 lh-26 c-black" style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 26px; color:#282828;">--}}
                                                                                                                                            ...
                                                                                                                                            {{--<br />--}}
                                                                                                                                            {{--AED {{totalServiceCharge($order->id)}}--}}
                                                                                                                                    {{--</tr>--}}
                                                                                                                                {{--</table>--}}
                                                                                                                            {{--</th>--}}
                                                                                                                        {{--</tr>--}}
                                                                                                                                    ...
                                                                                                                                    {{--<td align="right">--}}
                                                                                                                                        ...
                                                                                                                                        {{--<table border="0" cellspacing="0" cellpadding="0" class="mw-100p" style="min-width: 200px;">--}}
                                                                                                                                            {{--<tr>--}}
                                                                                                                                                {{--<td class="btn-20 btn-secondary c-white l-white" bgcolor="#f3189e" style="font-size:20px; line-height:24px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; min-width:auto !important; border-radius:10px; background:linear-gradient(to right, #9028df 0%,#f3189e 100%); color:#ffffff;">--}}
                                                                                                                                                    {{--<a href="#" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">--}}
                                                                                                                                                        {{--<span class="link c-white" style="text-decoration:none; color:#ffffff;">TOTAL:  AED {{totalServiceCharge($order->id)}}--}}
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="pb-30" style="padding-bottom: 30px;">
                                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="text-16 lh-26 pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; padding-bottom: 0px;">
                                                                                                                            <br/>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="p-50 mpx-15" bgcolor="#2a2273;" style="border-radius: 0 0 10px 10px; padding: 50px; background: #2a2273;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" class="pb-20" style="padding-bottom: 20px;">
                                                                <!-- Socials -->
                                                                <a href="http://serviceonus.com/" target="_blank"><img src="{{asset('gallery/Logo-Option-2.png')}}" width="150" height="60" border="0" alt="" /></a>

                                                                <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px">
                                                                    <tr>
                                                                        <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                            <a href="{{$s->fb_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_facebook.png" width="34" height="34" border="0" alt="" /></a>
                                                                        </td>
                                                                        <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                        <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                            <a href="{{$s->instagram_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_instagram.png" width="34" height="34" border="0" alt="" /></a>
                                                                        </td>
                                                                        <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                        <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                            <a href="{{$s->twitter_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_twitter.png" width="34" height="34" border="0" alt="" /></a>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                <i class="fa fa-phone"></i>{{$s->phone_1}}
                                                                <br />

                                                                <a href="mailto:{{$s->email_1}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{$s->email_1}}</span></a> -  <a href="mailto:{{$s->email_1}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{$s->email_2}}</span></a>                                                        </td>
                                                        </tr>
