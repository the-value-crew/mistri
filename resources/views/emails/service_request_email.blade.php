                                                                                ...
                                                                                <tr>
                                                                                    <td class="pb-50" style="padding-bottom: 50px;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; margin-bottom: 20px">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="text-16 lh-26 a-center pb-25" style="font-size:18px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                                                                        New request received from <span style="font-weight: 600">Service Provider : {{$vendor->name}}</span> to provide <span style="font-weight: 600">Service : {{$service->name}}</span> .
