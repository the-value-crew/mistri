                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$page->title}}</td>
                                            <td>
                                                <a href="{{asset('uploads/page/'.$page->image)}}" data-lightbox="example{{$page->id}}"><img class="img-style" src="{{asset('uploads/page/'.$page->image)}}"  /></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="col-md-4">
                                                    <a href="{{route('page.edit',$page->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                                </div>
                                                <div class="col-md-1"></div>
                                                <div class="col-md-3">

                                                    <button class="btn btn-danger btn-sm remove" value="{{$page->id}}"> <i class="fa fa-trash-o"></i> </button>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
