            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('edit.profile.submit')}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group label-floating is-empty">
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="{{asset('dashboard/img/'.$user->image)}}" id="image" class="img-thumbnail img-responsive" alt="">
                                    </div>
