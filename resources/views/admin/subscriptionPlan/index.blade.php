                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach($plans as $plan)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-md-4">
                                                    <a href="{{route('subscription-plan.edit',$plan->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                                </div>
                                                <div class="col-md-1"></div>
                                                <div class="col-md-3">

                                                    <button class="btn btn-danger btn-sm remove" value="{{$plan->id}}"> <i class="fa fa-trash-o"></i> </button>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
