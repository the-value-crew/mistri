                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($services as $service)
                                    @php
                                    $user = \App\User::find($service->user_id);
                                    $data = \App\Service::find($service->service_id);
                                    $user_service = \Illuminate\Support\Facades\DB::table('user_service')->where('service_id',$service->service_id)->where('user_id',$service->user_id)->first();
