                                ...
                                @foreach($services as $service)
                                    <tr>
                                            ...
                                            <div class="form-group">
                                                <div class="togglebutton">
                                                    <label class="lead" style="color:black;font-weight:bold;font-size:11pt;">
                                                        <input type="checkbox" name="feature" @if($service->feature == "on") checked @endif  onchange="changeServiceStatus({{$service->id}})">
                                                    </label>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('edit.form',['id'=>$service->id,'slug'=>\Illuminate\Support\Str::slug($service->name)])}}" class="btn btn-success asdh-btn-small btn-warning"><i class="fa fa-edit"></i> Edit Form</a>

                                            <a href="{{route('service.edit',$service->id)}}" class="btn btn-primary asdh-btn-small " title="Edit Service
{{$service->name}}"> <i class="fa fa-edit"></i> Edit Service </a>
