...
@section('title','Edit Select Option Field')
@push('css')
                ...
                <div class="card">
                    ...
                    <div class="card-head" data-background-color="">
                        ...
                        <div class="card-title">
                            <h4><b>Edit Select Option Field </b></h4>
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('update.selectOptionfield',$field->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label>Select Field Label</label>
                                <input type="text"  class="form-control" name="field" id="title" value="{{$field->label}}">
                                @if ($errors->has('title'))
                            ...
                            <table class="table option-table" style="margin-top: 5px">
                                <thead>
                                <td><u><b>Service Check Options</b></u></td>
                            ...
                            <button type="button" class="btn btn-sm btn-primary" style="margin-left: 20px" id="add_another_selectoption"><span class="material-icons">add</span> Add Options<div class="ripple-container"></div></button>
...
//                $('tbody').append(html);
    ...
    function myFunction(id) {
        ...
        $.ajax({
            url:'{!!URL::to('admin/select-option-value/')!!}' + '/' + id,
            type : "POST",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#SelectTable").on("click", "#DeleteButton5", function() {
            $(this).closest("tr").remove();
        });

        var count5 =1;

        dynamic_field5(count5);

        function dynamic_field5(number) {
            html ="<tr>";

            html+= "<td><input type='text'  class='form-control' placeholder='Enter selct Option' name='select_option[]' required></td>";
            html+= "<td><input type='text'  class='form-control' placeholder='Enter Charge ' name='select_charge[]' required></td>";


            if(number>1)
            {
                html+='<td id="DeleteButton5"><i class="fa fa-trash" aria-hidden="true"></i></td>';
//                $('tbody').append(html);
        ...
        $('#add_another_selectoption').click(function () {
