            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('update.timefield',$field->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <br><br>
                                            ...
                                            <table class="table option-table" style="margin-top: 5px">
                                                <thead>
                                                <tr>
                                                <td><u><b>Service Timings</b></u></td>
                                                <td><u><b>Action</b></u></td>
                                                </tr>
                                                </thead>
                                                @foreach($field->time_options as $option)
                                                    <tr>
                                                        <td>{{$option->time}}</td>
                                                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-primary" style="margin-left: 20px" id="add_another_time"><span class="material-icons">add</span> Add Time Option<div class="ripple-container"></div></button>
...
//                $('tbody').append(html);
    ...
    function myFunction(id) {
        ...
        $.ajax({
            url:'{!!URL::to('admin/time-option/')!!}' + '/' + id,
            type : "POST",
