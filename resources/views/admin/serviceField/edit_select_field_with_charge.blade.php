            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('update.selectFieldWithCharge',$field->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <table class="table option-table" style="margin-top: 5px">
                                ...
                                @foreach($field->select_with_charge_options as $option)
...
//                $('tbody').append(html);
    ...
    function myFunction(id) {
        ...
        $.ajax({
            url:'{!!URL::to('admin/select-option-with-charge/')!!}' + '/' + id,
            type : "POST",
