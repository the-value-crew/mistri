            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('update.checkField',$field->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <table class="table option-table" style="margin-top: 5px">
                                ...
                                @foreach($field->check_options as $option)
...
//                $('tbody').append(html);
    ...
    function myFunction(id) {
        ...
        $.ajax({
            url:'{!!URL::to('admin/check-option/')!!}' + '/' + id,
            type : "POST",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function dynamic_field2(number) {
            ...
            html+= "<td><input type='text'  class='form-control' placeholder='Enter  Option' name='option[]' required></td>";
