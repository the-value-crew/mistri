...
@section('title','Edit Radio Field')
@push('css')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form method="post" action="{{route('update.selectField',$field->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
...
//                $('tbody').append(html);
    ...
    function myFunction(id) {
        ...
        $.ajax({
            url:'{!!URL::to('admin/select-option/')!!}' + '/' + id,
            type : "POST",
