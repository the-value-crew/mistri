                                ...
                                @foreach($missions as $enquiry)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="col-md-4">
                                                <a href="{{route('our-mission.edit',$enquiry->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        table.on('click', '.remove', function(e) {
            ...
            swal({
                ...
                $.ajax({
                    url:'{!!URL::to('admin/general-enquiry/')!!}' + '/' + id,
                    type : "POST",
