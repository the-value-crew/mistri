            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header" data-background-color="">
                        <h4 class="card-title"><b>City/State</b></h4>
                    </div>
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($cities as $city)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('all.areas',['city_name'=>$city->name,'city_id'=>$city->id])}}"><span class="material-icons">list_alt</span><sub>({{count($city->areas)}})</sub></a></td>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <button type="button" rel="tooltip" class="btn btn-danger btn-simple remove" value="{{$city->id}}" data-original-title="" title="">
